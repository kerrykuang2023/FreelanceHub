...
async function runAsRole(browser, role, credentials, testCases) {
  console.log(`\n${'='.repeat(60)}`);
...
async function main() {
  ...
  const adminTests = [
    ...
    async () => {
      await page.goto(`${BASE_URL}/admin/configuration`, { waitUntil: 'networkidle', timeout: 30000 });
    ...
    async () => {
      await page.goto(`${BASE_URL}/admin/config/work-types`, { waitUntil: 'networkidle', timeout: 30000 });
    ...
    async () => {
      await page.goto(`${BASE_URL}/admin/config/tax-rates`, { waitUntil: 'networkidle', timeout: 30000 });
    ...
    async () => {
      await page.goto(`${BASE_URL}/admin/config/currencies`, { waitUntil: 'networkidle', timeout: 30000 });
    ...
    async () => {
      await page.goto(`${BASE_URL}/admin/config/languages`, { waitUntil: 'networkidle', timeout: 30000 });
    ...
    async () => {
      await page.goto(`${BASE_URL}/admin/config/job-natures`, { waitUntil: 'networkidle', timeout: 30000 });
    ...
    async () => {
      await page.goto(`${BASE_URL}/admin/config/work-formats`, { waitUntil: 'networkidle', timeout: 30000 });
    ...
    async () => {
      await page.goto(`${BASE_URL}/admin/config/rate-types`, { waitUntil: 'networkidle', timeout: 30000 });
    ...
    async () => {
      await page.goto(`${BASE_URL}/admin/config/invoice-types`, { waitUntil: 'networkidle', timeout: 30000 });
    ...
    async () => {
      await page.goto(`${BASE_URL}/admin/config/payment-methods`, { waitUntil: 'networkidle', timeout: 30000 });
  ...
  const hrTests = [
    async () => {
      await page.goto(`${BASE_URL}/hr/dashboard`, { waitUntil: 'networkidle', timeout: 30000 });
    ...
    async () => {
      await page.goto(`${BASE_URL}/post-job`, { waitUntil: 'networkidle', timeout: 30000 });
  ...
  const freelancerTests = [
    ...
    async () => {
      await page.goto(`${BASE_URL}/work-logs`, { waitUntil: 'networkidle', timeout: 30000 });
    ...
    async () => {
      await page.goto(`${BASE_URL}/create-work-log`, { waitUntil: 'networkidle', timeout: 30000 });
  ...
  const publicTests = [
    ...
    async () => {
      await page.goto(`${BASE_URL}/jobs`, { waitUntil: 'networkidle', timeout: 30000 });
