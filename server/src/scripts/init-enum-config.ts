...
const enumConfigs = [
  ...
  { config_type: SYSTEM_CONFIG_TYPES.WORK_LOG_STATUS, config_key: 'submitted', config_value: '待审�?, display_name: '待审�?, display_order: 2 },
  { config_type: SYSTEM_CONFIG_TYPES.WORK_LOG_STATUS, config_key: 'confirmed', config_value: '已确�?, display_name: '已确�?, display_order: 3 },
  { config_type: SYSTEM_CONFIG_TYPES.WORK_LOG_STATUS, config_key: 'rejected', config_value: '已驳�?, display_name: '已驳�?, display_order: 4 },
  { config_type: SYSTEM_CONFIG_TYPES.WORK_LOG_STATUS, config_key: 'invoiced', config_value: '已开�?, display_name: '已开�?, display_order: 5 },
  { config_type: SYSTEM_CONFIG_TYPES.WORK_LOG_STATUS, config_key: 'paid', config_value: '已付�?, display_name: '已付�?, display_order: 6 },

  // ==================== 发票状�?====================
  { config_type: SYSTEM_CONFIG_TYPES.INVOICE_STATUS, config_key: 'draft', config_value: '草稿', display_name: '草稿', display_order: 1 },
  { config_type: SYSTEM_CONFIG_TYPES.INVOICE_STATUS, config_key: 'submitted', config_value: '待审�?, display_name: '待审�?, display_order: 2 },
  { config_type: SYSTEM_CONFIG_TYPES.INVOICE_STATUS, config_key: 'approved', config_value: '已通过', display_name: '已通过', display_order: 3 },
  { config_type: SYSTEM_CONFIG_TYPES.INVOICE_STATUS, config_key: 'rejected', config_value: '已驳�?, display_name: '已驳�?, display_order: 4 },
  { config_type: SYSTEM_CONFIG_TYPES.INVOICE_STATUS, config_key: 'sent', config_value: '已发�?, display_name: '已发�?, display_order: 5 },
  { config_type: SYSTEM_CONFIG_TYPES.INVOICE_STATUS, config_key: 'paid', config_value: '已付�?, display_name: '已付�?, display_order: 6 },
  { config_type: SYSTEM_CONFIG_TYPES.INVOICE_STATUS, config_key: 'cancelled', config_value: '已取�?, display_name: '已取�?, display_order: 7 },
  ...
  { config_type: SYSTEM_CONFIG_TYPES.INVOICE_TYPE, config_key: 'service_fee', config_value: '服务费发�?, display_name: '服务费发�?, display_order: 4 },

  // ==================== 发票税务计算模式 ====================
  { config_type: SYSTEM_CONFIG_TYPES.INVOICE_TAX_MODE, config_key: 'inclusive', config_value: '含税�?, display_name: '含税�?, display_order: 1 },
  ...
  { config_type: SYSTEM_CONFIG_TYPES.PAYMENT_METHOD, config_key: 'alipay', config_value: '支付�?, display_name: '支付�?, display_order: 2 },
  ...
  { config_type: SYSTEM_CONFIG_TYPES.PAYMENT_STATUS, config_key: 'submitted', config_value: '待审�?, display_name: '待审�?, display_order: 2 },
  { config_type: SYSTEM_CONFIG_TYPES.PAYMENT_STATUS, config_key: 'approved', config_value: '已批�?, display_name: '已批�?, display_order: 3 },
  { config_type: SYSTEM_CONFIG_TYPES.PAYMENT_STATUS, config_key: 'rejected', config_value: '已驳�?, display_name: '已驳�?, display_order: 4 },
  { config_type: SYSTEM_CONFIG_TYPES.PAYMENT_STATUS, config_key: 'payment_initiated', config_value: '付款�?, display_name: '付款�?, display_order: 5 },
  { config_type: SYSTEM_CONFIG_TYPES.PAYMENT_STATUS, config_key: 'paid', config_value: '已付�?, display_name: '已付�?, display_order: 6 },
  { config_type: SYSTEM_CONFIG_TYPES.PAYMENT_STATUS, config_key: 'cancelled', config_value: '已取�?, display_name: '已取�?, display_order: 7 },
  ...
  { config_type: SYSTEM_CONFIG_TYPES.PAYMENT_TYPE, config_key: 'project_payment', config_value: '项目�?, display_name: '项目�?, display_order: 2 },
  { config_type: SYSTEM_CONFIG_TYPES.PAYMENT_TYPE, config_key: 'advance_payment', config_value: '预付�?, display_name: '预付�?, display_order: 3 },
  ...
  { config_type: SYSTEM_CONFIG_TYPES.PAYMENT_TYPE, config_key: 'refund', config_value: '退�?, display_name: '退�?, display_order: 6 },
  { config_type: SYSTEM_CONFIG_TYPES.PAYMENT_TYPE, config_key: 'other', config_value: '其他', display_name: '其他', display_order: 7 },

  // ==================== 单位类型 ====================
  { config_type: SYSTEM_CONFIG_TYPES.UNIT_TYPE, config_key: 'day', config_value: '�?, display_name: '�?, display_order: 1 },
  { config_type: SYSTEM_CONFIG_TYPES.UNIT_TYPE, config_key: 'month', config_value: '�?, display_name: '�?, display_order: 2 },
  ...
  { config_type: SYSTEM_CONFIG_TYPES.UNIT_TYPE, config_key: 'time', config_value: '�?, display_name: '�?, display_order: 5 },

  // ==================== 工作类型 ====================
  { config_type: SYSTEM_CONFIG_TYPES.WORK_TYPE, config_key: 'onsite_dev', config_value: '现场开�?, display_name: '现场开�?, display_order: 1 },
  ...
  { config_type: SYSTEM_CONFIG_TYPES.WORK_TYPE, config_key: 'requirement_analysis', config_value: '需求分�?, display_name: '需求分�?, display_order: 8 },
  ...
  // ==================== 公司状�?====================
  { config_type: SYSTEM_CONFIG_TYPES.COMPANY_STATUS, config_key: 'pending', config_value: '待审�?, display_name: '待审�?, display_order: 1 },
  { config_type: SYSTEM_CONFIG_TYPES.COMPANY_STATUS, config_key: 'approved', config_value: '已通过', display_name: '已通过', display_order: 2 },
  { config_type: SYSTEM_CONFIG_TYPES.COMPANY_STATUS, config_key: 'rejected', config_value: '已驳�?, display_name: '已驳�?, display_order: 3 },

  // ==================== 申请状�?====================
  { config_type: SYSTEM_CONFIG_TYPES.APPLICATION_STATUS, config_key: 'submitted', config_value: '已申�?, display_name: '已申�?, display_order: 1 },
  { config_type: SYSTEM_CONFIG_TYPES.APPLICATION_STATUS, config_key: 'viewed', config_value: '已查�?, display_name: '已查�?, display_order: 2 },
  { config_type: SYSTEM_CONFIG_TYPES.APPLICATION_STATUS, config_key: 'interview_scheduled', config_value: '已安排面�?, display_name: '已安排面�?, display_order: 3 },
  { config_type: SYSTEM_CONFIG_TYPES.APPLICATION_STATUS, config_key: 'interviewed', config_value: '已面�?, display_name: '已面�?, display_order: 4 },
  ...
  { config_type: SYSTEM_CONFIG_TYPES.APPLICATION_STATUS, config_key: 'rejected', config_value: '已拒�?, display_name: '已拒�?, display_order: 8 },
  { config_type: SYSTEM_CONFIG_TYPES.APPLICATION_STATUS, config_key: 'withdrawn', config_value: '已撤�?, display_name: '已撤�?, display_order: 9 },

  // ==================== 挂靠状�?====================
  { config_type: SYSTEM_CONFIG_TYPES.AFFILIATION_STATUS, config_key: 'active', config_value: '活跃', display_name: '活跃', display_order: 1 },
  { config_type: SYSTEM_CONFIG_TYPES.AFFILIATION_STATUS, config_key: 'pending', config_value: '待审�?, display_name: '待审�?, display_order: 2 },
  { config_type: SYSTEM_CONFIG_TYPES.AFFILIATION_STATUS, config_key: 'suspended', config_value: '已暂�?, display_name: '已暂�?, display_order: 3 },
  { config_type: SYSTEM_CONFIG_TYPES.AFFILIATION_STATUS, config_key: 'terminated', config_value: '已终�?, display_name: '已终�?, display_order: 4 },
  ...
  { config_type: SYSTEM_CONFIG_TYPES.PROJECT_DURATION, config_key: '1_year', config_value: '1�?, display_name: '1�?, display_order: 4 },
  { config_type: SYSTEM_CONFIG_TYPES.PROJECT_DURATION, config_key: '2_years', config_value: '2�?, display_name: '2�?, display_order: 5 },
  ...
  { config_type: SYSTEM_CONFIG_TYPES.INTERVIEW_TYPE, config_key: 'technical', config_value: '技术面�?, display_name: '技术面�?, display_order: 5 },
  ...
  { config_type: SYSTEM_CONFIG_TYPES.RECOMMENDATION_LEVEL, config_key: 'neutral', config_value: '一�?, display_name: '一�?, display_order: 3 },
  { config_type: SYSTEM_CONFIG_TYPES.RECOMMENDATION_LEVEL, config_key: 'not_recommended', config_value: '不推�?, display_name: '不推�?, display_order: 4 },

  // ==================== 优先�?====================
  { config_type: SYSTEM_CONFIG_TYPES.PRIORITY, config_key: 'low', config_value: '�?, display_name: '�?, display_order: 1 },
  { config_type: SYSTEM_CONFIG_TYPES.PRIORITY, config_key: 'medium', config_value: '�?, display_name: '�?, display_order: 2 },
  { config_type: SYSTEM_CONFIG_TYPES.PRIORITY, config_key: 'high', config_value: '�?, display_name: '�?, display_order: 3 },
  { config_type: SYSTEM_CONFIG_TYPES.PRIORITY, config_key: 'urgent', config_value: '紧�?, display_name: '紧�?, display_order: 4 },

  // ==================== 用户角色 ====================
  { config_type: SYSTEM_CONFIG_TYPES.USER_ROLE, config_key: 'job_seeker', config_value: '求职�?, display_name: '求职�?, display_order: 1 },
  { config_type: SYSTEM_CONFIG_TYPES.USER_ROLE, config_key: 'hr_recruiter', config_value: 'HR招聘', display_name: 'HR招聘', display_order: 2 },
  { config_type: SYSTEM_CONFIG_TYPES.USER_ROLE, config_key: 'admin', config_value: '管理�?, display_name: '管理�?, display_order: 3 },

  // ==================== 用户角色状�?====================
  { config_type: SYSTEM_CONFIG_TYPES.USER_ROLE_STATUS, config_key: 'pending', config_value: '待审�?, display_name: '待审�?, display_order: 1 },
  { config_type: SYSTEM_CONFIG_TYPES.USER_ROLE_STATUS, config_key: 'approved', config_value: '已通过', display_name: '已通过', display_order: 2 },
  { config_type: SYSTEM_CONFIG_TYPES.USER_ROLE_STATUS, config_key: 'rejected', config_value: '已驳�?, display_name: '已驳�?, display_order: 3 },
  { config_type: SYSTEM_CONFIG_TYPES.USER_ROLE_STATUS, config_key: 'frozen', config_value: '已冻�?, display_name: '已冻�?, display_order: 4 },
  ...
  // ==================== 性别 ====================
  { config_type: SYSTEM_CONFIG_TYPES.GENDER, config_key: 'male', config_value: '�?, display_name: '�?, display_order: 1 },
  { config_type: SYSTEM_CONFIG_TYPES.GENDER, config_key: 'female', config_value: '�?, display_name: '�?, display_order: 2 },
  ...
  // ==================== 设备类型 ====================
  { config_type: SYSTEM_CONFIG_TYPES.DEVICE_TYPE, config_key: 'desktop', config_value: '桌面�?, display_name: '桌面�?, display_order: 1 },
  { config_type: SYSTEM_CONFIG_TYPES.DEVICE_TYPE, config_key: 'mobile', config_value: '移动�?, display_name: '移动�?, display_order: 2 },
  ...
  // ==================== 货币 ====================
  { config_type: SYSTEM_CONFIG_TYPES.CURRENCY, config_key: 'CNY', config_value: '人民�?, display_name: '人民�?, display_order: 1 },
